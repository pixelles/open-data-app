<?php
/**
* Description: a file containing all the repetitive layout codes for the top half of a page. This file is specifically for the Administration-related pages.
*
	...
	<header>	
		...
		<nav>
			...
			<ul>
				...
				<li><a href="index.php">Administration</a></li> &middot; 
